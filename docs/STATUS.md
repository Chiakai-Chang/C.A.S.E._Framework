...
9/9 最新：[修復設定對照](evaluation/2026-09-09-repair-thinking-report.md)兩組完整產物皆通過；off 約 132 秒，medium 約 458 秒。採 off 作為本機明確修復的後續驗證候選，不改全域設定、不外推成功率。尚待驗證修復後的完整核對／integration 旅程；以下保留較早結果。
