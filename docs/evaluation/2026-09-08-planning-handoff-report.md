...
後續[驗收改善復盤](../research/2026-09-08-acceptance-improvement-review.md)補正優先順序：已有可信檢查與 reviewer／repair，本次 worker-only 未測後者，不能推定框架漏驗；先核對既有防線，再比較提前結構檢查的效果及成本。以下保留當時判斷脈絡。
