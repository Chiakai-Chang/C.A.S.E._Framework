...
更新：2026-09-11。此頁區分工程行為、模型結果及交付狀態；測試數不代替模型效果。套件仍為 **2.0.0-preview.1**，本次工作分支尚未合併／推送。
...
| 面向 | 已知結果與限制 |
|---|---|
| 工程回歸 | 完整 kit **335 項：333 通過、2 項 Windows 符號連結權限跳過**；新增 review-evidence 模組，由 integrations 封裝規則納入 |
