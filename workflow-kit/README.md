...
2026-09-10：pi 一般來源預設提供版本化索引、按需讀取，明確 inline 仍附全文。最新正常任務已產出完全正確的成果，但獨立核對期間達原時間上限，尚未完成整體驗收。本批保留工作分支，未合併／推送；預覽功能存在不等於核心品質目標已達成。[最新結果與歷史失敗](docs/READINESS.md)
