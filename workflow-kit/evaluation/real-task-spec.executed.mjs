...
export function gradeRealTask(project, frozenHashes = sourceHashes()) {
  let actual, error;
  ...
  return { passed: artifactPassed && sourcesUnchanged, artifactPassed, sourcesUnchanged, sourceIntegrity, mismatches, ...(error ? { error } : {}) };
}
